const stories = [
    {
        ...
        content: [
            "Distributed Crayons and Coloring Books: We gifted each child a set of crayons and a coloring book to spark creativity and add color to their day.",
            "Engaged in Fun Games: We organized simple, joyful games to create a lively and cheerful atmosphere for the children.",
            "Heartfelt Conversations: We spent quality time talking and bonding with the children, offering them emotional comfort and companionship.",
            "Spread Positivity and Smiles: Through our presence, laughter, and kind gestures, we aimed to bring happiness, hope, and strength to these brave little warriors.",
            "🗓 Date: 1 July 2025 • 🕙 Time: 10:30 AM – 12:30 PM",
            "📍 Venue: Childhood Cancer Hospital, Egmore • 🎯 Cause: Childhood cancer and humanitarian service",
            "👧 Total Beneficiaries: 100 children • 🧑‍🤝‍🧑 Leos Participated: 13 • ⏱ Leo Hours: 26 hours",
            "💸 Funds Spent: ₹3000 – 50 pairs of surgical gloves – ₹400 • 130 crayons – ₹1300 • 130 colouring books – ₹1300",
        ],
    },
    {
        ...
        date: "2025-07-05",
        authors: ["Leo Kartigayani K", "Leo Lakshita M S"],
        description:
        ...
        content: [
            ...
            "📊 Impact Summary: Total Beneficiaries: 135 elders • Leos Participated: 4 • Lions Participated: 4 • Leo Hours: 40 hours • Funds Spent: ₹1,500 (~$17.65)",
            "❤️ Gratitude: Special thanks to Lion Dr. G. Chandrasekar, Lion Manoj Seeralan, Lion R. Vasantha Kumar, Lion T. Swaminathan, Leo Sharan Kumar P B, and all the volunteers who made this event a success.",
        ],
    },
    {
        ...
        content: [
            ...
            "📍 Location: Tower Park, Anna Nagar • 🗓 Date: 6 July 2025 • 🕘 Time: 7:30 AM – 10:00 AM • 🗑 Plastic Collected: 12 kg",
            "👥 Beneficiaries: 220 people • 🧍 Leos: 4 • 🙋 Volunteers: 35 • ⏱ Leo Hours: 10 • 💸 Funds Spent: ₹400",
